...
async function updatePreferences(caregiverId: string, args: Json) {
  const payload: Json = {
    ...
    medication_reminders: args.medicationReminders !== false,
    daily_summaries: args.dailySummaries !== false,
    important_patient_events: args.importantPatientEvents !== false,
